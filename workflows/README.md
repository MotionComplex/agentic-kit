...
|---|---|---|
| [`claude-review-loop/`](claude-review-loop/) | Automated PR review + fix loop using the Claude GitHub App, billed against your Pro/Max subscription. Auto-merge on pass; `human-gate` holds merge for manual review. | `claude-review-loop/install.sh /path/to/repo` |
