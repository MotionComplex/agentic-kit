...
const tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), 'speclever-test-'));
process.env.SPECLEVER_DATA = tmpDir;
...
test('DATA_DIR honours SPECLEVER_DATA and initDataDir scaffolds the layout', () => {
